...
<head>
    ...
    <script type="text/javascript"
            src="<?php bloginfo('url'); ?>/wp-content/plugins/buddypress/bp-core/js/jquery-cookie.js"></script>
    ...
    <style type="text/css">
        .front_page .container span input {
            height: 25px;
        }
    </style>
...
<div id="header">
    ...
    <div class="container">
        <a href="<?php echo home_url('/'); ?>">
            <img src="<?php bloginfo('template_url'); ?>/images/gsa-logo.png" alt="" class="logo">
        </a>
        <span>
            <form id="searchform" action="<?php echo home_url('/'); ?>" method="get" role="search">
                <label>Search</label>
                <input type="text" name="s" class="front_page_search" id="s"/>
